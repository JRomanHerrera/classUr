...
cdef class Class:
    ...
    # Defined twice ?
    def Omega_m(self):
        return self.ba.Omega0_b+self.ba.Omega0_cdm+self.ba.Omega0_ncdm_tot + self.ba.Omega0_dcdm + self.ba.Omega0_sfdm
    ...
    def omega_dm(self):
        return (self.ba.Omega0_cdm + self.ba.Omega0_sfdm) * self.ba.h * self.ba.h
    ...
    def get_current_derived_parameters(self, names):
        ...
        for name in names:
            if name == 'h':
            ...
            elif name == 'Omega0_sfdm':
                value = self.ba.Omega0_sfdm
            elif name == 'age':
                value = self.ba.age
                ...
                value = (self.ba.Omega0_b + self.ba.Omega0_cdm+
                         self.ba.Omega0_ncdm_tot + self.ba.Omega0_dcdm +self.ba.Omega0_sfdm)
            elif name == 'omega_m':
                value = (self.ba.Omega0_b + self.ba.Omega0_cdm+
                         self.ba.Omega0_ncdm_tot + self.ba.Omega0_dcdm + self.ba.Omega0_sfdm)/self.ba.h**2
            elif name == 'tau_reio':
